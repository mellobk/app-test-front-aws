export const EMPTY_FILE = 'Este campo no puede estar vacio';
...
export const CURRENCY_ERROR = '*debes ingresar un formato valido';
export const MAX_FROM_NOW_DATE = '*La fecha no puede ser mayor a hoy';
export const ONLY_LETTER_FIELD_ERROR = '*El campo sólo puede contener letras';
